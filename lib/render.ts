...
<head>
  ...
  <style>
    ...
    .reader-toolbar {
      ...
      justify-content: center; padding: 0.75rem 1rem; background: rgba(255,255,255,0.6);
      border-radius: 9999px; margin-bottom: 1.5rem; backdrop-filter: blur(4px);
      box-shadow: 0 2px 8px rgba(0,0,0,0.05); transition: background 0.2s;
    }
    .reader-toolbar button {
      background: transparent; border: 1px solid #ccc; border-radius: 9999px;
      padding: 0.25rem 0.75rem; font-size: 0.9rem; cursor: pointer;
